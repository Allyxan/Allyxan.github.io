...
* Веб-страничка с описанием лабораторных работ доступна по ссылке: [Отчет](https://Allyxan.github.io/tanki-otchet/).
...
### Использованные средства разработки ПО:
...
Кроме этого, было принято непосредственное участие в тестировании продукта и - немного - его разработке (в местах, требующих особое внимание к математическим и физическим формулам)
